...
export function Characters() {
    ...
    const handlePage = (page, name) => {
        setLoad(true);
        getPage(page, name).then(data=>{setChars(data.results); setLoad(false)});
    }
    ...
    return (
        ...
        {pages>1&&(<Pagination pages={pages} handlePage={handlePage} name={name}/>)}
            {
